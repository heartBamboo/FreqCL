...
class SequentialCIFAR100(ContinualDataset):
    ...
    def get_DWT_transform():
        test_transform = transforms.Compose(
            [transforms.ToTensor(), transforms.Normalize(SequentialCIFAR100.MEAN, SequentialCIFAR100.STD)])
    ...
    def get_DWT_backbone():
        #return DWT_resnet18(SequentialCIFAR10.N_CLASSES_PER_TASK * SequentialCIFAR10.N_TASKS)
