...
class CIC_IIoT_2025_Train(Dataset):
    """
    ...
    def __init__(self, root, train=True, transform=None,
        ...
        data_np, label_list, class_list = self.load_data('CIC_IIoT_2025', 128, train=self.train, train_ratio=0.8, seed=3407)
    ...
    def load_data(self, dataset_name: str, packet_length: int, train: bool = True, train_ratio: float = 0.8,
        ...
        classes = list(torch.load(f'{dataset_dir}/label_map.pt').values())
...
class CIC_IIoT_2025_Test(CIC_IIoT_2025_Train):
    """Base CIC_IIoT_2025 dataset."""
    ...
    def __getitem__(self, index: int, ret_segmask=False) -> Tuple[type(Image), int, type(Image)]:
        ...
        if ret_segmask or self._return_segmask:
            ...
            seg = transforms.ToTensor()(transforms.CenterCrop((CIC_IIoT_2025_Train.IMG_SIZE, CIC_IIoT_2025_Train.IMG_SIZE))(seg))[0]
...
class Sequential_CIC_IIoT_2025(ContinualDataset):
    ...
    N_TASKS = 5
    SIZE = (CIC_IIoT_2025_Train.IMG_SIZE, CIC_IIoT_2025_Train.IMG_SIZE)
    # MEAN, STD = (0.4856, 0.4994, 0.4324), (0.2272, 0.2226, 0.2613) # RGB
    MEAN, STD = (0.4856,), (0.2272,)  # 单通道的均值和标准差
    TRANSFORM = transforms.Compose([
        #transforms.RandomCrop(CIC_IIoT_2025_Train.IMG_SIZE, padding=4),
        #transforms.RandomHorizontalFlip(),
        transforms.ToTensor(),
        transforms.Normalize(MEAN, STD)
        ])
    TEST_TRANSFORM = CIC_IIoT_2025_Train.TEST_TRANSFORM
    ...
    def get_data_loaders(self) -> Tuple[torch.utils.data.DataLoader, torch.utils.data.DataLoader]:
        ...
        CIC_IIoT_2025_Train_dataset = CIC_IIoT_2025_Train(base_path() + 'CIC_IIoT_2025', train=True, transform=transform)
        CIC_IIoT_2025_Test_dataset = CIC_IIoT_2025_Test(base_path() + 'CIC_IIoT_2025', train=False, transform=test_transform)

        train, test = store_masked_loaders(
            CIC_IIoT_2025_Train_dataset, CIC_IIoT_2025_Test_dataset, self)
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), Sequential_CIC_IIoT_2025.TRANSFORM])
        return transform

    @staticmethod
    def get_DWT_transform():
        test_transform = transforms.Compose(
            [transforms.ToTensor(), transforms.Normalize(Sequential_CIC_IIoT_2025.MEAN, Sequential_CIC_IIoT_2025.STD)])
    ...
    @staticmethod
    def get_backbone():
        #return resnet18(Sequential_CIC_IIoT_2025.N_CLASSES_PER_TASK * Sequential_CIC_IIoT_2025.N_TASKS)
        num_classes = Sequential_CIC_IIoT_2025.N_CLASSES_PER_TASK * Sequential_CIC_IIoT_2025.N_TASKS
    ...
    def get_DWT_backbone():
        #return DWT_resnet18(Sequential_CIC_IIoT_2025.N_CLASSES_PER_TASK * Sequential_CIC_IIoT_2025.N_TASKS)
        num_classes = Sequential_CIC_IIoT_2025.N_CLASSES_PER_TASK * Sequential_CIC_IIoT_2025.N_TASKS
        #MambaVision_B
    ...
    def get_normalization_transform():
        transform = transforms.Normalize(
            Sequential_CIC_IIoT_2025.MEAN, Sequential_CIC_IIoT_2025.STD)
        return transform

    @staticmethod
    def get_denormalization_transform():
        transform = DeNormalize(Sequential_CIC_IIoT_2025.MEAN, Sequential_CIC_IIoT_2025.STD)
        return transform
