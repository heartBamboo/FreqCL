...
def process_ToN_IoT(dataset_dir: str, output_dir: str, num_flow_packets: int = 5, header_length: int = 160,
    ...
    label_names = ['benign', 'Backdoor', 'DDoS', 'Ransomware', 'SQL_Injection','Password', 'Vulnerability_Scanner', 'XSS', 'Port_Scanning', 'Uploading', 'OS_Fingerprinting', 'MITM']
...
if __name__ == '__main__':
    ...
    input_dir = '/data/users/lph/projects/IIOT_Incremental_Learning/data/Edge_IIoT_Select'
    save_dir = '/data/users/lph/projects/IIOT_Incremental_Learning/data/Edge_IIoT_Select'
    five_tuple_output_dir =  '/data/users/lph/projects/IIOT_Incremental_Learning/data/Edge_IIoT_Select'
