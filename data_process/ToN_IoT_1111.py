...
if __name__ == '__main__':
    num_flow_packets = 8
    raw_header_length_hex = 216  # 这里是（32+12） * 2 （32+12是加上了ip和端口的长度，里面会处理掉ip和端口，但是这里得先加上）
    raw_payload_length_hex = 64 # 这里是96 * 2 （不知道为什么要乘2才能达到原本的设定）
    batch_size = 1

    input_dir = '/data/users/lph/projects/IIOT_Incremental_Learning/data/ToN_IoT_Select2'
    save_dir = '/data/users/lph/projects/IIOT_Incremental_Learning/data/ToN_IoT'
    five_tuple_output_dir =  '/data/users/lph/projects/IIOT_Incremental_Learning/data/ToN_IoT'
