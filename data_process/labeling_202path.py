...
# 定义输入和输出路径
input_csv = '/data3/lph/dataset/IOT/ToN_IoT/SecurityEvents_Network_datasets/GroundTruth_Network_4.csv'  # CSV 文件路径
input_pcap_dir = '/data3/lph/IIOT_IncrementLearning/data/ToN_IoT_split/normal_attack/unzip_202501161305_normal_scanning/normal_scanning'  # 分割后的 PCAP 文件目录
output_dir = '/data3/lph/IIOT_IncrementLearning/data/ToN_IoT_Label'  # 输出目录
lock_file = '/data3/lph/IIOT_IncrementLearning/data/ToN_IoT_Label/lockfile.lock'  # 锁文件路径
cache_file = '/data3/lph/IIOT_IncrementLearning/data/ToN_IoT_Label/normal_scanning_cache_4.pkl'  # 缓存文件路径
...
if __name__ == '__main__':
    ...
    max_workers = 192  # 通常是 CPU 核心数的 1-2 倍

    # 设置批量处理的大小
    batch_size = 2000  # 每次处理 100 个文件
