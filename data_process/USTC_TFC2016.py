...
def process_USTC_TFC2016(dataset_dir: str, output_dir: str, num_flow_packets: int = 5, header_length: int = 160,
...
if __name__ == '__main__':
    ...
    input_dir = '/data/users/lph/projects/IIOT_Incremental_Learning/data/USTC_TFC2016_Split'
    save_dir = '/data/users/lph/projects/IIOT_Incremental_Learning/data/USTC_TFC2016'
    five_tuple_output_dir =  '/data/users/lph/projects/IIOT_Incremental_Learning/data/USTC_TFC2016'
    process_USTC_TFC2016(input_dir, save_dir, num_flow_packets, raw_header_length_hex, raw_payload_length_hex, batch_size, five_tuple_output_dir)
